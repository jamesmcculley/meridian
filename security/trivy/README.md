...
- **Image scan** (`trivy image ghcr.io/jamesmcculley/meridian-core:latest`) — scans the last published container image from main. Keeps the deployed image clean between build-sign.yml runs.
